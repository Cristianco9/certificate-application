...
const options = {
  ...
  // Secret key for verifying the JWT specific to records
  secretOrKey: config.recordAppJwtKey
};

/**
 * JWT strategy for Passport authentication for recorders.
 ...
 */
export const recordAppJwtStrategy = new Strategy(options, (payload, done) => {

...
module.exports = {
  /**
   * Insert all 1,123 Colombian municipalities.
   * Department IDs are resolved dynamically via a single query.
   * If a department is not found, its municipalities are skipped with a warning.
   */
  up: async (queryInterface, Sequelize) => {
    // 1. Fetch all departments from the database (only those belonging to Colombia)
    const departments = await queryInterface.sequelize.query(
      `SELECT id_departamento, nombre_departamento FROM departamento WHERE id_pais = 1`,
      { type: queryInterface.sequelize.QueryTypes.SELECT }
    );

    // 2. Build a map: department name -> id
    const deptMap = {};
    departments.forEach(dept => {
      deptMap[dept.nombre_departamento] = dept.id_departamento;
    });

    // 3. Define municipalities grouped by department (1,123 records)
    const citiesByDepartment = {
      ...
      'Antioquia': [
        ...
        'Caldas', 'Campamento', 'Cañasgordas', 'Caramanta', 'Carolina',
        ...
        'Jericó', 'La Ceja', 'La Estrella', 'La Unión', 'Liborina', 'Maceo',
        'Marinilla', 'Montebello', 'Murindó', 'Mutatá', 'Nariño', 'Nechí',
        'Necoclí', 'Olaya', 'Peque', 'Pueblorrico', 'Puerto Berrío', 'Puerto Nare',
        ...
        'San Vicente', 'Santa Bárbara', 'Santa Rosa de Osos', 'Santa Fe de Antioquia',
        'Santo Domingo', 'Segovia', 'Sopetrán', 'Támesis', 'Tarazá', 'Tarso',
      ...
      'Atlántico': [
        'Barranquilla', 'Baranoa', 'Candelaria', 'Campo de la Cruz', 'Galapa',
      ...
      'Bolívar': [
        ...
        'Córdoba', 'Clemencia', 'El Guamo', 'El Carmen de Bolívar', 'Hatillo de Loba',
        'Magangué', 'Mahates', 'Margarita', 'María la Baja', 'Montecristo',
        'Mompós', 'Morales', 'Norosí', 'Pinillos', 'Regidor', 'Río Viejo',
        'San Cristóbal', 'San Estanislao', 'San Fernando', 'San Jacinto',
        'San Jacinto del Cauca', 'San Juan Nepomuceno', 'San Martín de Loba',
        'San Pablo', 'Santa Catalina', 'Santa Rosa de Lima', 'Santa Rosa del Sur',
      ...
      'Boyacá': [
        ...
        'Beteitiva', 'Boavita', 'Boyacá', 'Briceño', 'Buenavista', 'Busbanzá',
        ...
        'Floresta', 'Gachantivá', 'Gámeza', 'Garagoa', 'Guacamayas', 'Guateque',
        'Guayatá', 'Güicán', 'Iza', 'Jenesano', 'Jericó', 'La Capilla', 'La Uvita',
        'La Victoria', 'Labranzagrande', 'Macanal', 'Maripí', 'Miraflores',
        'Mongua', 'Monguí', 'Moniquirá', 'Motavita', 'Muzo', 'Nobsa', 'Nuevo Colón',
        'Oicatá', 'Otanche', 'Pachavita', 'Páez', 'Paipa', 'Pajarito', 'Panqueva',
        ...
        'Tipacoque', 'Toca', 'Tópaga', 'Tota', 'Tununguá', 'Turmequé', 'Tuta',
        'Tutazá', 'Úmbita', 'Ventaquemada', 'Villa de Leyva', 'Viracachá',
        'Zetaquirá'
      ],
      'Caldas': [
      ...
      'Cauca': [
        ...
        'Silvia', 'Sotara', 'Suárez', 'Sucre', 'Timbío', 'Timbiquí', 'Toribío',
        'Totoró', 'Villa Rica'
      ],
      'Cesar': [
      ...
      'Chocó': [
        ...
        'Bajo Baudo', 'Belén de Bajirá', 'Bojayá', 'Carmen del Darién',
        'Cértegui', 'Condoto', 'El Cantón del San Pablo', 'El Carmen de Atrato',
        'El Litoral del San Juan', 'Istmina', 'Juradó', 'Lloró', 'Medio Atrato',
        'Medio Baudo', 'Medio San Juan', 'Nóvita', 'Nuquí', 'Río Iró', 'Río Quito',
      ...
      'Córdoba': [
        ...
        'Los Córdobas', 'Momil', 'Moñitos', 'Planeta Rica', 'Pueblo Nuevo',
      ...
      'Cundinamarca': [
        'Bogotá D.C.', 'Agua de Dios', 'Albán', 'Anapoima', 'Anolaima', 'Apulo',
        ...
        'Guataquí', 'Guatavita', 'Guayabal de Siquima', 'Guayabetal', 'Gutiérrez',
        ...
        'Ubaque', 'Ubaté', 'Une', 'Útica', 'Vergara', 'Vianí', 'Villagómez',
        'Villapinzón', 'Villeta', 'Viotá', 'Yacopí', 'Zipacón', 'Zipaquirá'
      ],
      'Guainía': ['Inírida', 'Cacahual', 'La Guadalupe', 'Mapiripana', 'Morichal', 'Pana Pana', 'Puerto Colombia', 'San Felipe'],
      ...
      'Meta': [
        ...
        'El Dorado', 'Fuente de Oro', 'Granada', 'Guamal', 'Mapiripán',
        'Mesetas', 'La Macarena', 'Uribe', 'Lejanías', 'Puerto Concordia',
        'Puerto Gaitán', 'Puerto López', 'Puerto Lleras', 'Puerto Rico',
      ...
      'Nariño': [
        ...
        'Cumbal', 'Cumbitara', 'Chachagüí', 'El Charco', 'El Peñol', 'El Rosario',
        'El Tablón de Gómez', 'El Tambo', 'Funes', 'Guachucal', 'Guaitarilla',
        'Gualmatán', 'Iles', 'Imués', 'Ipiales', 'La Cruz', 'La Florida',
        'La Llanada', 'La Tola', 'La Unión', 'Leiva', 'Linares', 'Los Andes',
        'Magüí', 'Mallama', 'Mosquera', 'Nariño', 'Olaya Herrera', 'Ospina',
        'Francisco Pizarro', 'Policarpa', 'Potosí', 'Providencia', 'Puerres',
        'Pupiales', 'Ricaurte', 'Roberto Payán', 'Samaniego', 'Sandoná',
      ...
      'Norte de Santander': [
        ...
        'Cáchira', 'Chinácota', 'Chitagá', 'Convención', 'Cucutilla', 'Durania',
      ...
      'Tolima': [
        ...
        'Santa Isabel', 'Suárez', 'Valle de San Juan', 'Venadillo',
        'Villahermosa', 'Villarrica'
      ],
      'Valle del Cauca': [
        'Cali', 'Alcalá', 'Andalucía', 'Ansermanuevo', 'Argelia', 'Bolívar',
        'Buenaventura', 'Guadalajara de Buga', 'Bugalagrande', 'Caicedonia',
    ...
    // 4. Build the bulk insert array
    const municipalities = [];
    for (const [deptName, cityList] of Object.entries(citiesByDepartment)) {
      const deptId = deptMap[deptName];
      if (!deptId) {
        console.warn(`Department "${deptName}" not found in the database. Skipping its municipalities.`);
        continue;
      }
      cityList.forEach(cityName => {
        municipalities.push({
          nombre_municipio: cityName,
          id_departamento: deptId,
        });
      });
    }

    // 5. Insert all municipalities
    console.log(`Inserting ${municipalities.length} municipalities...`);
    await queryInterface.bulkInsert('municipio', municipalities);
  },

  /**
   * Remove all municipalities that belong to Colombia.
   */
